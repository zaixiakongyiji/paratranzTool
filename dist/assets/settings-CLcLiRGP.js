const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vectorStore-CSCThsyl.js","assets/index-D-Nc9a5v.js","assets/index-DHAYdvpI.css","assets/storage-CDYOJb6j.js","assets/ai-C8C5Ab_V.js"])))=>i.map(i=>d[i]);
import{_ as u}from"./index-D-Nc9a5v.js";import{Storage as E}from"./storage-CDYOJb6j.js";function h(l,a,f,i,e,t={}){const{isOptional:n=!1,hasPrompt:o=!1,hasRefCount:g=!1}=t,v=n?i[`${e}Enabled`]:!0,p=i[`${e}ApiFormat`]||i.aiApiFormat||"openai",m=i[`${e}BaseUrl`]||"",r=i[`${e}ApiKey`]||"",y=i[`${e}Model`]||"",b=o&&i[`${e}Prompt`]||"",s=g&&i[`${e}RefCount`]||3;return`
